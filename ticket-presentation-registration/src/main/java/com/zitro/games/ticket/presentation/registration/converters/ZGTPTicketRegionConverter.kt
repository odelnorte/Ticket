...
import com.zitro.games.ticket.presentation.registration.ZGPTRegionApiModel
...
class ZGTPTicketRegionConverter @Inject constructor(@ApplicationContext private val context: Context) :
    CommonResultConverter<ZGTDTicketRegionUseCase.Response, ZGTPTicketRegistrationApiModel>() {
