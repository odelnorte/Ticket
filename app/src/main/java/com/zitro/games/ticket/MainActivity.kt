...
import com.zitro.games.ticket.presentation.pending.view.pending.ZGTPPTicketPendingScreen
import com.zitro.games.ticket.presentation.registration.ZGTPTicketRegistrationScreen
import com.zitro.games.ticket.presentation.status.ZGTPStatusScreen
...
fun App(navController: NavHostController) {
    NavHost(navController, startDestination = NavRoutes.AtServiceTicketStatus.route) {
