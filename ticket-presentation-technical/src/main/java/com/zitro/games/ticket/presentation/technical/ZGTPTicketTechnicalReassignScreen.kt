...
@Composable
fun ZGTPPTicketTechnicalReassignScreen(
    viewModel: ZGTPTicketTechnicalViewModel,
    technicalInput: CPTicketTechnicalReassignInput,
    ...
    ZGPCMessageDialog(
        ...
        when(it){
            ...
            ZGPCMessageTypeButton.ZGPC_BUTTON_CONTINUE -> {
                viewModel.submitAction(ZGTPTicketTechnicalUiAction.TechnicalTicketReassign(
                    ZGTDTicketReassignRequest(
                        token = technicalInput.dataUser.token ?: "" ,
                        ticketId = technicalInput.dataTicket.ticketId ?: 0,
